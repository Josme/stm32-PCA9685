...
extern "C" {
	...
	typedef struct
{
    int fd;							/** Specifies the address for the PCA9685 */
    int *pwmWrite;		/** Specifies if the outputs should be inverted   												This parameter can be any value of PCA9685_InvOutputs_TypeDef */	/** Specifies the output driver
    												This parameter can be any value of PCA9685_OutputDriver_TypeDef */
	  int *digitalRead;	/** Specifies what the outputs should be when OE=1
    												This parameter can be any value of PCA9685_OutputNotEn_TypeDef */
	  int *analogRead;			/** Specifies what output frequency to use
